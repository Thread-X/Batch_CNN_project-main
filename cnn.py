...
train_data = np.array(pd.read_csv('data/pre_train.csv'))[:,:41]
train_label = np.array(pd.read_csv('data/pre_train.csv'))[:,41]
test_data = np.array(pd.read_csv('data/pre_test.csv'))[:,:41]
test_label = np.array(pd.read_csv('data/pre_test.csv'))[:,41]
